// Name: jsQR
// ID: kubohiroyajsqr
// Description: Read QR code text from a shared TurboWarp camera source.
// By: Hiroya Kubo
// License: MPL-2.0
...
(function (Scratch) {
  ...
  //#endregion
  //#region src/block-definitions.json
  var import_jsQR = /* @__PURE__ */ __toESM((/* @__PURE__ */ __commonJSMin(((exports, module) => {
  	...
  	blocks: [
  		{
  			...
  			"blockType": "COMMAND",
  			"text": "wait for QR code on camera [CAMERA_ID] set runtime var [RUNTIME_VAR] to text",
  			"description": "Waits until a QR code is detected on the named camera and stores its text in a runtime variable.",
  			"arguments": {
  				"CAMERA_ID": {
  					"type": "STRING",
  		...
  		},
  		{
  			...
  			"blockType": "COMMAND",
  			"text": "wait for QR code on camera [CAMERA_ID] set runtime var [RUNTIME_VAR] to text and broadcast [MESSAGE]",
  			"description": "Waits until a QR code is detected on the named camera, stores its text, and broadcasts a message.",
  			"arguments": {
  				"CAMERA_ID": {
  					"type": "STRING",
  					"defaultValue": "default"
  		...
  		},
  		{
  			...
  			"blockType": "REPORTER",
  			"text": "last QR text",
  			"description": "Returns the most recent QR text detected by this extension.",
  			"arguments": {}
  		}
  	]
  };
  ...
  function abortError() {
  	const error = /* @__PURE__ */ new Error("QR scanning was aborted.");
  ...
  var JsQrExtension = class {
  	...
  	scanFrame(frame) {
  		...
  		return (0, import_jsQR.default)(image.data, width, height)?.data ?? null;
  	}
  	cameraSource() {
  		const candidate = this.runtime().ext_kubohiroyacamerasource;
  		if (!isRecord(candidate) || typeof candidate.acquireCamera !== "function") throw new Error("jsQR requires @kubohiroya/turbowarp-camera-source.");
  		return candidate;
  	}
  	runtime() {
  	...
  	writeRuntimeVariable(name, value) {
  		...
  		if (!temporaryVariables || typeof temporaryVariables.setRuntimeVariable !== "function") throw new Error("Temporary Variables (lmsTempVars2) must be loaded before using jsQR blocks.");
  ...
  Scratch.extensions.register(new JsQrExtension());
  //#endregion
